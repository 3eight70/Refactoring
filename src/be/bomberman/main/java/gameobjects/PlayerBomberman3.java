...
public class PlayerBomberman3 extends Player {
            ...
            if (!bomberman.jouerEnLigne) {
                ...
                if (name.equals(bomberman.playerName)) {
                    ...
                    if (bomberman.msg.trim().split("-")[0].equals("Zelda")) {
                        ...
                        if (bomberman.ilFautPlacerUneBombe) {
    ...
    public void render(Screen screen) {
        ...
        if (xT != 0) {
            if (0 <= teleportTimer && teleportTimer < 4)
                screen.renderEntity(xT, yT, SheetSquare.tp1, 32, false, false, 0xff527B9C);
            if (4 <= teleportTimer && teleportTimer < 8)
                screen.renderEntity(xT, yT, SheetSquare.tp2, 32, false, false, 0xff527B9C);
            if (8 <= teleportTimer && teleportTimer < 12)
                screen.renderEntity(xT, yT, SheetSquare.tp3, 32, false, false, 0xff527B9C);
            if (12 <= teleportTimer && teleportTimer < 16)
                screen.renderEntity(xT, yT, SheetSquare.tp4, 32, false, false, 0xff527B9C);
            if (16 <= teleportTimer && teleportTimer < 20)
                screen.renderEntity(xT, yT, SheetSquare.tp5, 32, false, false, 0xff527B9C);
            if (20 <= teleportTimer && teleportTimer < 24)
                screen.renderEntity(xT, yT, SheetSquare.tp6, 32, false, false, 0xff527B9C);
            if (24 <= teleportTimer && teleportTimer < 28)
                screen.renderEntity(xT - 16, yT - 16, SheetSquare.tp7, 64, false, false, 0xff527B9C);
            if (28 <= teleportTimer && teleportTimer < 32)
